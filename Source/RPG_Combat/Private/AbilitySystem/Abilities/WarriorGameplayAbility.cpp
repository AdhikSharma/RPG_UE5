...
UPawnCombatController* UWarriorGameplayAbility::GetPawnCombatControllerFromActorInfo() const
{
	return GetAvatarActorFromActorInfo()->FindComponentByClass<UPawnCombatController>();
}
