 ...
 */
UCLASS()
class RPG_COMBAT_API UWarriorInputComponent : public UEnhancedInputComponent
{
	GENERATED_BODY()
...
{
	checkf(InInputConfig,TEXT("Inout data asset is null, can not proceed with binding"));
